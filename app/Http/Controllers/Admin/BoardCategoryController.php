...
use App\Models\BulletinBoardCategoryModel as MainModel;
...
class BoardCategoryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/boardCategories";
        $this->pathViewController = "{$this->prefix}.pages.boardCategory";
    ...
    public function form(Request $request)
    {
        $id = $request->id;
        $item = [];
        $title = "Create a New Board Category";
