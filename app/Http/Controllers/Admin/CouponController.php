...
class CouponController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/coupon";
        $this->pathViewController = "{$this->prefix}.pages.coupon";
    ...
    public function form(Request $request)
    {
        ...
        $tracks = $this->trackModel->listItems([],['task' => 'list']);
        $users = $this->userModel->listItems(['status' => 'active','role' =>'user'],['task' => 'list']);
