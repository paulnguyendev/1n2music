...
use App\Models\FaqCategoryModel as MainModel;
use Carbon\Carbon;
...
class FaqCategoryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/faqCategory";
        $this->pathViewController = "{$this->prefix}.pages.faqCategory";
    ...
    function list(Request $request)
    {
        ...
        $params['is_map'] = '1';
        $params['with'] = '1';
        $params['controllerNameChild'] =  "{$this->prefix}/faq";
