...
class FaqController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/faq";
        $this->pathViewController = "{$this->prefix}.pages.faq";
    ...
    public function index(Request $request)
    {
        ...
        $parentController = "{$this->prefix}/faqCategory";
    ...
    public function save(Request $request)
    {
        ...
        $item = [];
        if (!$id) {
            $params['redirect'] = rrt_route($this->controllerName . "/index",['category' => $category]);
        } else {
            $item = $this->model->getItem(['id' => $id, 'with' => '1'], ['task' => 'user_id']);
            $params['id'] = $id;
        }
        ...
        if (empty($error)) {
            ...
            $params['id'] = $id;
            $actionName = $id ? "Update" : "Add";
            $params['message'] = "{$actionName} successfully" ;
            return $params;
        } else {
