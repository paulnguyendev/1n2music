...
class FreeboardController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/freeBoard";
        $this->pathViewController = "{$this->prefix}.pages.freeboard";
    ...
    function list(Request $request)
    {
        ...
        $recordsTotal = $this->model->listItems(['count' => '1'], ['task' => 'free-board']);
        $recordsFiltered = 10;
        $data = [];
        $params = [];
        $params['start'] = $start;
        ...
        if ($searchValue) {
            ...
            $recordsTotal = $this->model->listItems(['search' => $searchValue, 'count' => '1'], ['task' => 'free-board']);
        }
        $params['is_map'] = '1';
        $params['with'] = '1';
        $params['controllerName'] = $this->controllerName;
        $data = $this->model->listItems($params, ['task' => 'free-board']);
