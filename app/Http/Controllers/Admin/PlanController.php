...
class PlanController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/plan";
        $this->pathViewController = "{$this->prefix}.pages.plan";
    ...
    public function save(Request $request)
    {
        ...
        $pricing_monthly = $params['pricing_monthly'] ?? 0;
        $is_contact = isset($params['is_contact']) && $params['is_contact'] ? 1 : 0;
        $params['is_contact'] = $is_contact;
        if(!is_numeric($pricing_monthly)) {
            $error['pricing_monthly'] = "Please enter the correct format";
        }
        if (empty($error)) {
