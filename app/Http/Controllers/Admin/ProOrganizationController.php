...
use App\Models\ProOrganizationModel as MainModel;
...
#Helper
class ProOrganizationController extends Controller
{
    private $prefix;
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/proorganization";
        $this->pathViewController = "{$this->prefix}.pages.proOrganization";
    ...
    public function form(Request $request)
    {
        $id = $request->id;
        $item = [];
        $title = "Create a New Pro Organization";
