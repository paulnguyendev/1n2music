...
use App\Models\RelatedContentModel as MainModel;
...
class RelatedContentsController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/relatedContents";
        $this->pathViewController = "{$this->prefix}.pages.relatedcontent";
    ...
    public function form(Request $request)
    {
        $id = $request->id;
        $item = [];
        $title = "Create a New Related Content";
