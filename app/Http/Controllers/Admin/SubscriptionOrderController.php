...
use App\Models\SubscriptionOrderModel as MainModel;
use Carbon\Carbon;
...
class SubscriptionOrderController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->controllerName = "{$this->prefix}/subscriptionOrder";
        $this->pathViewController = "{$this->prefix}.pages.subscriptionOrder";
    ...
    function list(Request $request)
    {
        ...
        $filteredData = $data;
        if ($slug){
            $filteredData = array_filter($data, function ($item) use ($slug) {
                return isset($item['subscription']) && $item['subscription']['slug'] === $slug;
            });
        }
