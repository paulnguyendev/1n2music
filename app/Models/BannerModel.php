...
class BannerModel extends Model
{
    ...
    protected $fillable = ['category_banner_id', 'link', 'is_banner_homepage', 'new_image', 'id', 'name', 'description', 'content', 'created_at', 'image'];
    ...
    public function listItems($params = "", $options = "")
    {
        ...
        if ($options['task'] == 'admin') {
            ...
            if (isset($params['category_banner_id'])) {

                $query = $query->where('category_banner_id', $params['category_banner_id']);
            }
    ...
    {
        return $this->belongsTo(CategoryBannerModel::class, 'category_banner_id');
    }
