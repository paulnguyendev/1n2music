...
class BulletinBoardCommentModel extends Model
{
    protected $table = 'rrt_bulletin_board_comments';
    ...
    protected $fillable = ['id', 'thread_id', 'user_id', 'parent_id', 'content', 'created_at'];
    ...
    {
        return $this->hasMany(BulletinBoardCommentReactionModel::class);
    }
}
