...
class BulletinBoardCommentReactionModel extends Model
{
    protected $table = 'rrt_bulletin_board_comment_reactions';
    ...
    protected $fillable = ['id', 'comment_id','user_id','reaction','created_at'];
