...
class ContractSettingModel extends Model
{
    protected $table = 'rrt_contract_settings';
    ...
    protected $fillable = ['id', 'contract_id', 'user_id', 'status', 'enabled', 'description', 'featureList', 'deliverables', 'isFeatured', 'category'];
    ...
    {
        return $this->belongsToMany(TrackModel::class, 'rrt_contracts_tracks', 'contact_setting_id', 'track_id');
    }
