...
class CouponModel extends Model
{
    ...
    protected $fillable = ['id', 'name','code','type','track_id','user_id','apply_all_user','start_date','end_date','discount_type','discount_number','is_send_mail','created_at'];
