...
class MasteringAudioModel extends Model
{
    protected $table = 'rrt_mastering_audios';
    protected $primaryKey = 'id';
    public $timestamps = false;
    const CREATED_AT = 'created_at';
    const UPDATED_AT = 'updated_at';
    protected $fieldSearchAccepted = ['email', 'phone', 'fullname'];
    protected $crudNotAccepted = ['_token', 'confirm_password', 'is_agree', 'cycle', 'plan_order', 'page', 'subscription_order', 'data_attributes','thumbnail_text','redirect','created_at','created_by_user'];
    protected $fillable = ['id', 'name','input','presign_url','output','preview_job_id','diagnose_job_id','status','file_resource_id','container_kind','container_duration','container_size','container_bitrate','audio_codec','audio_channels','audio_sample_rate','audio_duration','audio_bitrate','loudness_measured','loudness_true_peak','acoustic_entropy','channels','damage','dissonance','drr','dynamics','failure_reason','fully_downloadable','loudness','loudness_range','lowpass_true_peak_15khz','mastering3_acoustic_entropy','mastering3_ear_damage','mastering3_loudness','peak','frames','probe_json','rms','sample_rate','sharpness','sound_quality','sound_quality2','space','true_peak','youtube_loudness','user_id','created_at'];
