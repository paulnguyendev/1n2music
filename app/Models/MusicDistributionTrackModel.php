...
class MusicDistributionTrackModel extends Model
{
    protected $table = 'rrt_music_distribution_tracks';
    ...
    protected $fillable = [
        'file_size',
        'id', 'code', 'name', 'version', 'file', 'music_distribution_id', 'is_live_version', 'is_code_version', 'is_instrumental', 'genre_id', 'user_id', 'created_at', 'updated_at'
    ];
    ...
    {
        return $this->belongsTo(GenresModel::class, 'genre_id', 'id');
    }
}
