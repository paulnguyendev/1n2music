...
class MusicShopModel extends Model
{
    protected $table = 'rrt_music_distribution_shop_relation';
    ...
    protected $fillable = ['id', 'music_distribution_id', 'shop_id'];
    ...
    public function info() {
        return $this->belongsTo(MusicDistributionShopModel::class,'shop_id','id');
    }
}
