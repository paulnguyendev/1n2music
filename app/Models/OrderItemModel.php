...
{
    protected $table = 'rrt_order_items';
    ...
    protected $fillable = ['id', 'order_id', 'track_id', 'contract_track_id','user_id', 'price'];
    ...
    {
        return $this->belongsTo(OrderModel::class, 'order_id')->with('payment');
    }  
    ...
    public function contract_track()
    {
        return $this->belongsTo(TrackContractModel::class, 'contract_track_id')->with('contractSetting');
    }
}
