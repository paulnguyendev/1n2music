...
class OrderPaymentAccountModel extends Model
{
    protected $table = 'rrt_order_payment_account';
    ...
    protected $fillable = ['id','name','description','payment_id', 'created_at','updated_at'];
    ...
    {
        return $this->hasMany(PaymentAccountModel::class, 'payment_id', 'id');
    }
}
