...
{
    protected $table = 'rrt_order_payment';
    ...
    protected $fillable = ['id','name','has_child','is_default','url_redirect', 'created_at','updated_at'];
    ...
    {
        return $this->hasMany(OrderPaymentAccountModel::class, 'payment_id', 'id');
    }
}
