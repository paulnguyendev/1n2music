...
class PlanModel extends Model
{
    ...
    protected $fillable = ['id', 'name', 'description','commission', 'is_free', 'pricing_monthly', 'pricing_annually', 'content', 'slug', 'created_at', 'updated_at', 'order_number','default_signup'];
    ...
    public function getItem($params = [], $options = [])
    {
        ...
        if ($options['task'] == 'default_signup') {
            $result = $query->where('default_signup', 1)->first();
        }
        return $result;
    }
