...
{
    protected $table = 'rrt_subscriptions';
    ...
    protected $fillable = ['id', 'name', 'slug', 'price','pricing_annually', 'heading', 'content', 'agreement_url', 'background', 'created_at', 'updated_at','description'];
    ...
    {
        return $this->hasMany(SubscriptionOrderModel::class, 'subcription_id');
    }
}
