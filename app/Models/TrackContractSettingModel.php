...
class TrackContractSettingModel extends Model
{
    ...
    protected $fillable = ['id', 'contract_id', 'category', 'user_id', 'status','enabled','description','featureList','deliverables','isFeatured'];
    ...
    {
        return $this->belongsTo(ContractSettingModel::class, 'contact_setting_id');
    }
