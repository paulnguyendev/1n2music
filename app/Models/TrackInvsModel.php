...
class TrackInvsModel extends Model
{
    protected $table = 'rrt_tracks_invs';
    ...
    protected $fillable = ['id', 'track_id', 'invs_id'];
    ...
    {
        return $this->belongsToMany(TrackModel::class, 'rrt_tracks_genres', 'invs_id', 'track_id');
    }
