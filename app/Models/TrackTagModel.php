...
class TrackTagModel extends Model
{
    protected $table = 'rrt_track_tags';
    ...
    protected $fillable = ['id', 'track_id', 'name', 'update_at', 'created_at'];
    ...
    {
        return $this->belongsToMany(TrackTagModel::class, 'rrt_track_tags', 'name', 'track_id');
    }
