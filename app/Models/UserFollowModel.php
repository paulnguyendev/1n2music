...
{
    protected $table = 'rrt_user_follow';
    ...
    protected $fillable = ['id', 'follow_by_user_id', 'user_id', 'created_at'];
    ...
    public function listItems($params = "", $options = "")
    {
        ...
        if ($options['task'] == 'count') {
            $result =    $this->where('user_id', $params['user_id'])->count();
        }
        ...
        if ($options['task'] == 'count') {
            $result = $query->where('user_id', $params['user_id'])->count();
        }
        return $result;
    }
    public function getItem($params = [], $options = [])
    {
        ...
        if ($options['task'] == 'check') {
            ...
            $result = $query->where('follow_by_user_id', $params['follow_by_user_id'])->where('user_id', $params['user_id'])->first();
        }
        return $result;
    }
    ...
    {
        return $this->belongsTo(UserModel::class, 'follow_by_user_id');
    }
}
