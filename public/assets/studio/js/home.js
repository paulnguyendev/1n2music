...
jQuery(document).ready(function ($) {
  ...
  var recentSalesOption = {
    ...
    legendCallback: function (chart) {
      ...
      for (var i = 0; i < chart.data.datasets.length; i++) {
        text.push(
          '<div class="col-sm-6 col mr-3 ml-3 ml-sm-0 mr-sm-0 pr-md-0"><div class="row mb-3 align-items-center"><div class="col-md-2"><span class="legend-label" style="background-color:' +
            chart.data.datasets[i].backgroundColor[i] +
            '"></span></div><div class="col-md-9 pl-md-2"><h3 class="mb-0">$ ' +
            chart.data.datasets[i].data[i] +
            '</h3></div><div class="col-sm-12"><p class="text-muted">' +
  ...
  function textFormatter(label, series) {
    return (
      '<div style="font-size:10px; font-weight:700; text-align:center; color:#ffff;">' +
