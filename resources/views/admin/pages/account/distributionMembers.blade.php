@extends('admin.main')
@section('page_title', 'Distribution Members')
@section('title', 'Distribution Members')
@section('buttons')
    <!-- <a data-url="{{ rrt_route('admin/tools/packageUsage', ['account_type' => 'distribution']) }}"
        data-toggle="modal" 
    ...
    <a href="{{ rrt_route($controllerName . '/form', ['account_type' => 'distribution']) }}" class="btn btn-primary">{{__('Create a New Distribution')}}</a>
@endsection
@section('content')
    <style>
        .a {
            ...
            <div class="card">
                <div class="card-body a">
                    <table class="table table-xlg datatable-ajax"
                        data-source="{{ rrt_route($controllerName . '/list', ['account_type' => 'distribution']) }}"
    ...
    <script>
        var columnDatas = [{
            ...
            },
            {
                ...
                name: "created_at",
                render: function(data) {
                    return (!data.tax_type) ? '' : data.taxtypes.name;
                },
                className: "text-left",
                orderable: false,
                searchable: false
        ...
        WBDatatables.addDownloadButton(`{{rrt_route($controllerName . "/export",['type' => 'distribution'])}}`, 'Export Users');
