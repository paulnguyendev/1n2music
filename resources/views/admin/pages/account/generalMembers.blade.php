@extends('admin.main')
@section('page_title', 'Seller Members')
@section('title', 'Seller Members')
@section('css')
    <link href="https://cdn.jsdelivr.net/gh/gitbrent/bootstrap4-toggle@3.6.1/css/bootstrap4-toggle.min.css" rel="stylesheet">

@section('buttons')
    <!-- <a data-url="{{ rrt_route('admin/tools/packageUsage', ['account_type' => 'seller']) }}"
        data-toggle="modal" 
    ...
    <a href="{{ rrt_route($controllerName . '/form', ['account_type' => 'seller']) }}" class="btn btn-primary">{{__('Create a New Account')}}</a>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-xlg datatable-ajax"
                        data-source="{{ rrt_route($controllerName . '/list', ['account_type' => 'seller']) }}"
...
@push('script')
    ...
    <script>
        var columnDatas = [{
            ...
            },
            {
                ...
                render: function(data) {
                    ...
                    if (data.taxtypes) {
                        return (!data.taxtypes.name) ? '' : data.taxtypes.name;
                    } else {
                        return '';
                    }
        ...
        WBDatatables.addDownloadButton(`{{rrt_route($controllerName . "/export",['type' => 'seller'])}}`, 'Export Users');
