...
@section('buttons')
    <a href="{{ rrt_route($controllerName . '/form') }}" class="btn btn-primary">{{__('Create a New Banner')}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <table data-destroymulti="{{ rrt_route($controllerName . '/destroyMulti') }}"
                        class="table table-xlg datatable-ajax" data-source="{{ rrt_route($controllerName . '/list') }}"
                        data-destroymulti="">
                        <thead>
                            <tr>
        ...
        var columnDatas = [{
            ...
            },
            {
                ...
                render: function(data) {
                    ...
                    return `<img src="/public/uploads/banner/${data.image}" width="80px">`
                },
                className: "text-left",
                orderable: false,
                searchable: false
