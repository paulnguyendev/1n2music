@extends('admin.main')
@section('page_title', __('Board Categories'))
@section('title', __('Board Categories'))
@section('buttons')
    <a href="{{ rrt_route($controllerName . '/form') }}" class="btn btn-primary">@lang('Create a new Board Category')</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
