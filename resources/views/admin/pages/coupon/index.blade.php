...
@section('buttons')
    <a href="{{ rrt_route($controllerName . '/form') }}" class="btn btn-primary">{{__('Create a New Coupon')}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
    ...
    <script>
        var columnDatas = [{
            ...
            },
            {
                ...
                name: "fullname",
                render: function(data) {
                    return (!data.trackName) ? '' : data.trackName;
                },
                className: "text-left",
                orderable: false,
                searchable: false
            },
            {
                ...
                name: "fullname",
                render: function(data) {
                    return (!data.member_id) ? '' : data.member_id;
                },
                className: "text-left",
                orderable: false,
                searchable: false
            },
            {
                ...
                name: "fullname",
                render: function(data) {
                    return (!data.start_date) ? '' : data.start_date;
                },
                className: "text-left",
                orderable: false,
                searchable: false
            },
            {
                ...
                name: "fullname",
                render: function(data) {
                    return (!data.numberUse) ? 0 : data.numberUse;
                },
                className: "text-left",
                orderable: false,
                searchable: false
