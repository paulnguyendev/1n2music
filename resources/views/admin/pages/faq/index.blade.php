...
@section('buttons')
    <a href="{{ rrt_route($parentController . '/index') }}" class="btn btn-default">{{__('Back')}}</a>
    <a href="{{ rrt_route($controllerName . '/form',['category' => $category]) }}" class="btn btn-primary">{{__('Create a New FAQ')}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <table class="table table-xlg datatable-ajax" data-source="{{ rrt_route($controllerName . '/list',['category' => $category]) }}"
                        data-destroymulti="{{ rrt_route($controllerName . '/destroyMulti',['category' => $category]) }}">
                        <thead>
                            <tr>
