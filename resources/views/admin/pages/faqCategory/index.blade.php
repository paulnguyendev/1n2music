...
@section('buttons')
    <a href="{{ rrt_route($controllerName . '/form') }}" class="btn btn-primary">{{__('Create a New FAQ')}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
    ...
    <script>
        var columnDatas = [{
            ...
            },
            {
                ...
                name: "fullname",
                render: function(data) {
                    return (!data.number) ? 0 : data.number;
                },
                className: "text-left",
                orderable: false,
                searchable: false
            ...
            },
            {
                data: null,
                render: function(data) {
                    const routeEdit = data.route_form;
                    return (!routeEdit) ? '' :
