@extends('admin.main')
@section('page_title', 'Track Instruments & Vocals')
@section('title', 'Track Instruments & Vocals')
@section('buttons')
    <a href="{{ rrt_route($controllerName . '/form') }}" class="btn btn-primary">{{__('Create a New Instruments & Vocals')}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
