@extends('admin.main')
@section('page_title', 'Notice for Other')
@section('title', 'Notice for Other')
@section('buttons')
      <a href="{{rrt_route($controllerName . "/other/form")}}" class="btn btn-primary">{{__('Create a New Notice')}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <table class="table table-xlg datatable-ajax" data-source="{{ rrt_route($controllerName . '/list') }}?type=other"
                        data-destroymulti="">
                        <thead>
                            <tr>
