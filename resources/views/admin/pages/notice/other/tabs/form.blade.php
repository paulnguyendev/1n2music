        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <small>Each email is separated by a comma.</small>
                    <textarea class="form-control" required name="emails" placeholder="examplea@gmail.com,exampleb@gmail.com">{!! $item['emails'] ?? '' !!}</textarea>
