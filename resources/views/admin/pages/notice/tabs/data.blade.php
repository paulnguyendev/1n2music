                ...
                <div class="row">
                    <div class="col-md-3">
                        <input type="text" class="form-control" name="username"
                            placeholder="{{ __('User Name / Email') }}" value="{{ request('username') }}">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <select class="form-control" name="type" style="height: auto !important;">
                            <option value="">{{ __('Select Type') }}</option>
                            <option value="all" {{ request('type') == 'all' ? 'selected' : '' }}>
                                {{ __('All') }}</option>
                            <option value="basic" {{ request('type') == 'basic' ? 'selected' : '' }}>
                                {{ __('Basic') }}</option>
                            <option value="distribution" {{ request('type') == 'distribution' ? 'selected' : '' }}>
                                {{ __('Digital Distribution') }}</option>
                            <option value="publishing" {{ request('type') == 'publishing' ? 'selected' : '' }}>
                                {{ __('Publishing') }}</option>
                            <option value="seller" {{ request('type') == 'seller' ? 'selected' : '' }}>
                                {{ __('Seller') }}</option>
                        </select>
                    </div>
                    <div class="col-md-2">
