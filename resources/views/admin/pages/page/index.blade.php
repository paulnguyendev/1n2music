...
@section('buttons')
      <a href="{{rrt_route($controllerName . "/form",['type' => $type])}}" class="btn btn-primary">{{__('Create a New ' .  ucfirst($type))}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <table class="table table-xlg datatable-ajax" data-source="{{ rrt_route($controllerName . '/list',['type' => $type]) }}"
