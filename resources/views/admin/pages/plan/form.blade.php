                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pricing_monthly"
                                value="{{ $item['pricing_monthly'] ?? '' }}">
                            <span class="help-block"></span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            @php
                                $is_contact = $item['is_contact'] ?? 0;
                            @endphp
                            <div class="custom-control custom-checkbox primary-checkbox">
                                <input type="checkbox" {{$is_contact == "1" ? "checked" : ""}} class="custom-control-input" id="is_contact" name="is_contact">
                                <label class="custom-control-label" for="is_contact">{{__('Enable Contact By Email')}}</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">{{__('Order No')}}</label>
