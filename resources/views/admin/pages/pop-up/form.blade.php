@php
    $thumbnail = $item['pop_image'] ?? '';
    $thumbnailUrl = $thumbnail
        ? url('public/uploads/popup/' . $thumbnail)
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="file" class="d-none" id="image" name="pop_image">
                            <p class="text-center">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <label for="">{{ __('Embed Link') }}</label>
                                <input type="text" name="embed_link" class="form-control" value="{{ $item['embed_link'] ?? '' }}">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
