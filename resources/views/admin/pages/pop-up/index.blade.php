@extends('admin.main')
@section('page_title', 'Popup')
@section('title', 'Popup')
@section('buttons')
    <a href="{{ rrt_route($controllerName . '/form') }}" class="btn btn-primary">{{__('Create a New Popup')}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
    ...
    <script>
        var columnDatas = [{
            ...
            },
            {
                ...
                render: function(data) {
                    return WBDatatables.showTitle(data.id, data.route_edit, data.is_published,
                        data.published_at);
                },
                orderable: false,
                searchable: false
            },
            {
                ...
                name: "description",
                render: function(data) {
                    return (!data.pop_image)
                        ? '<img src="${data.pop_image}" alt="Image" style="width:50px; height:auto;">'
                        : `<img src="${data.pop_image}" alt="Image" style="width:50px; height:auto;">`;
                },
                className: "text-left",
                orderable: false,
            ...
            },
            {
                ...
                name: "description",
                render: function(data) {
                    return (!data.embed_link) ? 'No embed link' : data.embed_link;
                },
                className: "text-left",
                orderable: false,
                searchable: false
