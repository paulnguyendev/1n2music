@extends('admin.main')
@section('page_title', 'Pro Organization')
@section('title', 'Pro Organization')
@section('buttons')
    <a href="{{ rrt_route($controllerName . '/form') }}" class="btn btn-primary">{{__('Create a New Pro Organization')}}</a>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
