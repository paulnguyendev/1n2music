@extends('public.main')
@section('title', 'Register Distribution')
...
@section('content')
    ...
    <section class="section-selling-register rrt-section">
        <div class="container container-gap">
            <h1 class="title-main">Registerstartion for Distribution</h1>
            <form class="form-register-selling form-register"
                @if (count($user)) data-url="{{ rrt_route('public/join/distribution/postRegister') }}"
            @else
