...
<body>
    <div class="container"
        style="position:absolute; top:0; left:0;   margin-left:0px; padding-top:0px; padding-right:0px; padding-bottom:0px; padding:0px; background:#222222;">
        <div style="margin-top:0px;">
            <div class="row" style="margin:0; background:#ffffff; color:#111111; font-size:11px;">
                <div style="  padding-top:5px; padding-bottom:5px; padding-left:5px; padding-right:5px; ">
                    <div id="waveform" style="color:#000000">
                        <!-- Here be waveform -->
                    </div>
                </div>
            </div>
            ...
            <div style="display:flex; padding-top:9px; padding-bottom:9px; background:#ffffff;">
                ...
                <div id="stop_btn" style="display:flex; padding-left:5px;" onclick="wavesurfer.stop()">
                    <div class="btn btn-success btn-block"
                        style="display:flex; justify-content:center; align-items:center; background:#111111;color:#ffffff; min-width:100px !important; max-width:100px !important;">
                        <div
                            style="position:relative; top:-1px; margin-right:5px; display:flex; justify-content:center; align-items:center; font-size:20px; color:#fff;">
                ...
                <div style="display:flex; padding-left:5px;">
                    <div class="btn btn-success btn-block"
                        style="display:flex; justify-content:center; align-items:center; background:#111111;color:#ffffff; min-width:130px !important; max-width:130px !important;">
                        <div
                            style="position:relative; top:-1px; display:flex; justify-content:center; align-items:center; font-size:20px; color:#fff;">
                ...
                <div class="" id="playlist"
                    style="display:flex; justify-content:flex-start; align-items:center; width:100%; height:34px; background:#ffffff;">
                    <a id="media_name_href" href="{{ url('public/uploads/tracks/' . rawurlencode(!is_null($file) ? $file->name : '')) }}"></a>
                    <div class="media_name" id="media_name_0"
                        style="width:auto; display:flex; justify-content:flex-start; align-items:center; background:transparent; color:#111111; border-bottom:2px solid #007bff; height:100%; margin-left:10px; padding-top:0; padding-bottom:0; padding-left:0px; padding-right:2px; font-size:12px; border-radius:0px; cursor:pointer; overflow:hidden; white-space: nowrap;"
                        ...
                        <i class="glyphicon glyphicon-play"
                            ...
                            {{ str_replace('-', ' ', !is_null($file) ? $file->name : '') }}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div
                style="display:flex; color:#a1a1a1; background:#ffffff; margin-top:1px; text-align:right; padding-top:1px; padding-bottom:1px;">
                <div
                    style="display:flex; width:100%; margin-top:3px; padding-left:6px; color:#111111; text-align:left;  font-size:12px; overflow:hidden; white-space: nowrap;">
