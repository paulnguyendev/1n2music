    ...
    <div class="authen-wrap">
        <div class="authen-inner">
            <div class="authen-left">
                ...
                <form id="authen-form" action="{{ rrt_route($controllerName . '/postForgotPassword') }}" method="POST">
                    <div class="authen-form">
                        ...
                        <div class="form-group">
                            <button id="btn-continue" class="btn-authen" disabled>{{ __('Forgot Password') }}</button>
                        </div>
                    </div>
                </form>
