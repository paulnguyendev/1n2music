            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ ucfirst($methodName) ?? '' }}" readonly>
                    </div>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $methodInfo->name_holder ?? "" }}" readonly>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control " value="{{ rrt_show_price($payout->amount_supply) }}"
                            readonly>
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" readonly value="{{ rrt_show_price($payout->vat) }}">
                        <span class="help-block"></span>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ rrt_show_price($payout->amount_payment) }}" class="form-control"
                            readonly>
                        <span class="help-block"></span>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        @endphp
                        <input type="text" value="{{ $status }}" style="color: red" class="form-control "
                            readonly>
